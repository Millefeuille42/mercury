...
pub async fn part<'a>(args: Vec<&str>, channels: IRCCommChannels<'a>, ctx: &mut irc::Context) -> Result<(), Box<dyn Error>> {
	...
	let message = irc::Message::craft("PART", final_message.as_str(), ctx_)?;
